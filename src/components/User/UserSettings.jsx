  ...
  return (
    <div style={{ padding: '120px 20px 60px', minHeight: '100vh', background: '#f8fafc' }}>
      <div style={{ maxWidth: '800px', margin: '0 auto', background: 'white', borderRadius: '20px', padding: '40px', boxShadow: '0 10px 25px rgba(0,0,0,0.1)' }}>
        <h1 style={{ fontSize: '2rem', fontWeight: 'bold', marginBottom: '20px', color: '#1f2937' }}>Settings</h1>
        <p style={{ color: '#6b7280', marginBottom: '40px' }}>Manage your account preferences and settings</p>
        
        <div style={{ padding: '60px 20px', textAlign: 'center', color: '#6b7280' }}>
          <h3 style={{ marginBottom: '10px' }}>Settings Coming Soon</h3>
